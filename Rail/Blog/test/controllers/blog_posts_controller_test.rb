...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { blog_entry: @blog_post.blog_entry, post_title: @blog_post.post_title, user_id: @blog_post.user_id }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { blog_entry: @blog_post.blog_entry, post_title: @blog_post.post_title, user_id: @blog_post.user_id }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
